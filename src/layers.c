...
enum KeyNum_t layers[NumLayers][4][32] =
{
	// layer 0
	{
		...
		{ KB_LeftShift, KB_KeyboardSpacebar, KB_KeyboardTab, KB_RightAlt, KB_LeftControl, KB_LeftControl, },
		...
		{ KB_Layer01Enable, KB_KeyboardDelete, KB_KeyboardEscape, KB_LeftAlt, KB_KeyboardReturn, KB_ApostropheAndQuotationMark, },
	},
	// layer 1
	{
		{ KB_Transparent, KB_Transparent, KB_Transparent, KB_Digit1AndExclamationMark, KB_LeftArrow,
		  KB_Digit2AndAtSign,  KB_Digit3AndHash ,  KB_Digit4AndDollar , KB_Digit5AndPercent , KB_Digit6AndCaret,
		...
		{ KB_UpArrow, KB_EqualsAndPlus, KB_Transparent, KB_Transparent, KB_Transparent,
		  KB_Digit7AndAmpersand, KB_Digit8AndAsterisk, KB_Digit9AndLeftParenthesis, KB_Digit0AndRightParenthesis, KB_HyphenAndUnderscore,
